...
// Polymorphism
//  Mechanim 01: Function Overloading Mechanism
//      Defining Mutliple Functions With Same Name and Different Sigatures
//          i.e. Functions With Same Name, Different Number of Arguments/Types
//      It's Means You Can Overload Functions
//          Based On Number of Arguments or Type Of Arguments
//          NOT Based On Return Type of Function
class Maths {
    int result = 0;
    ...
    //     result = 0;
    //     result = x + y;
    //     System.out.println("Function : sum(int x, int y)");
    // }

    // void sum(int x, int y, int z) {
    //     result = 0;
    //     result = x + y + z;
    //     System.out.println("Function : sum(int x, int y, int z)");
    // }
    ...
    //         result += value;
    //     }
    //     System.out.println("Function: sum(int... values)");
    // }
...
public class ObjectOrientedProgramming {
    public static void playWitMaths() {
        Maths object = new Maths();
        object.sum(10, 20); // void sum(int, int)
        System.out.println("Result : " + object.getResult());

        // object.sum(10, 20, 30); // void sum(int, int, int)
        // System.out.println("Result : " + object.getResult());

        // object.sum(10, 20, 30, 90, 100); // void sum(int...)
        // System.out.println("Result : " + object.getResult());

        object.sum(10.9F, 20.1F); // void sum(float, float)
        System.out.println("Result : " + object.getResultFloat());

        object.sum(10.9F, 20.1F, 10.10F); // void sum(float, float, float)
        System.out.println("Result : " + object.getResultFloat());

        object.sum(10, 10.10F); // void sum(int, float)
        System.out.println("Result : " + object.getResultFloat());
    }
